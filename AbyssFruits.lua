...
function DiscordLib:Window(text)
	...
	CloseIcon.Image = "http://www.roblox.com/asset/?id=112925722451221"
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Label(text, color)
				...
				LabelTitle.TextColor3 = color or Color3.fromRGB(127, 131, 137)
				LabelTitle.TextSize = 30.000
